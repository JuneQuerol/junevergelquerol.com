...
export const metadata: Metadata = {
  title: "Unit Converter - June Vergel Querol",
  description: "Free online unit converter - Convert length, weight, temperature, area, volume, time, speed, and data storage units",
}
      ...
      <div className="container mx-auto px-5 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Convert between different units of measurement including length, weight, temperature, area, volume, time, speed, and data storage.
          </p>
        </div>
