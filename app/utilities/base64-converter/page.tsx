...
export const metadata: Metadata = {
  title: "Base64 Encoder/Decoder - June Vergel Querol",
  description: "Free Base64 encoder and decoder - Convert text and files to/from Base64 format",
}
      ...
      <div className="container mx-auto px-5 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Convert text and files to Base64 format or decode Base64 back to original content. Perfect for data encoding and web development.
          </p>
        </div>
